...
public class RegistrationController {
    ...
    @PostMapping("/signup")
    public ResponseEntity<JwtAuthenticationResponse> signup(@RequestBody final SignUpRequest request) {
        JwtAuthenticationResponse response = registrationService.registerUser(request);
